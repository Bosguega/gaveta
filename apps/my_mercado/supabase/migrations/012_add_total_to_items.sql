-- Migration: Add total column to items table and update save_receipt_atomic to include it

-- 1. Add total column to items table
ALTER TABLE public.items ADD COLUMN IF NOT EXISTS total numeric DEFAULT NULL;

-- 2. Update save_receipt_atomic to handle total

...
/**
 * Detecta se a URL atual é uma rota de lista compartilhada (/s/:code ou ?code=).
 * Executada antes de qualquer import pesado para garantir fast path.
 */
...
if (sharedCode) {
  // ---------------------------------------------------------------------------
  // SHARED CLIENT — mini-app independente
